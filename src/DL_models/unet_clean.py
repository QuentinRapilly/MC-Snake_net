...
class Level(nn.Module) :
    def __init__(self, ft_in, *, fst_c=None, down, scale_factor=2, convl, transit, convr, up, **kwargs) :
        super().__init__()
        self.down = down(in_ch = ft_in, out_ch = ft_in, scale_factor = scale_factor)
...
class UNetClean(nn.Module):
    ...
    def add_specific_args(parent_parser):
        ...
        parser.add_argument('--unet.inner_normalisation', '-inm', type=str, choices=['InstanceNorm', 'BatchNorm', 'None'], default='InstanceNorm')
        return parser
